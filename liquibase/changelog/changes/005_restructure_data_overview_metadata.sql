...
--changeset benedikt:016-rename-filename-to-original-filename
ALTER TABLE data_overview
RENAME COLUMN filename TO original_filename;

--changeset benedikt:017-merge-context-location-into-additionale-information
ALTER TABLE data_overview
...
--changeset benedikt:018-drop-link-column
ALTER TABLE data_overview
